...
from bricks.playground.domain_bricks import (
    build_registry,
    calculate_stats,
    divide,
    filter_rows,
...
from bricks.playground.runner import BricksRunner, PythonRunner
from bricks.playground.scenarios import (
    ALL_SCENARIOS,
    SCENARIO_1,
    SCENARIO_2,
    SCENARIO_3,
...
from bricks.playground.token_counter import TokenEstimator
...
class TestReport:
    ...
    def test_full_report_runs(self, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        from bricks.playground.report import print_full_report
