...
# Specific scenario
python -m bricks.playground.showcase.run --live --model claudecode --scenario CRM-pipeline
python -m bricks.playground.showcase.run --live --model claudecode --scenario TICKET-pipeline
